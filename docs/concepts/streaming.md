...
SecureClaw has two separate “streaming” layers:
...
When block streaming is enabled, SecureClaw can **merge consecutive block chunks**
...
When draft streaming is active, SecureClaw disables block streaming for that reply to avoid double-streaming.
