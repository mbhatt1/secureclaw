...
本指南总结了在 SecureClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 SecureClaw 状态目录下。默认为 `~/.secureclaw`。如果设置了 `SECURECLAW_STATE_DIR`，则使用该目录。

要重置所有内容：

- `secureclaw.json` 用于配置
...
- https://docs.secureclaw.app/testing
- https://docs.secureclaw.app/start/getting-started
