...
- 生成的 Swift 模型：`apps/macos/Sources/SecureClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/secureclaw/secureclaw/main/dist/protocol.schema.json
