...
SecureClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.secureclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["secureclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
