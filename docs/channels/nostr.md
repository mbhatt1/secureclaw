...
read_when:
  - You want SecureClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SecureClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`secureclaw onboard`) and `secureclaw channels add` list optional channel plugins.
...
```bash
secureclaw plugins install @secureclaw/nostr
```

Use a local checkout (dev workflows):

```bash
secureclaw plugins install --link <path-to-secureclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "secureclaw",
        "displayName": "SecureClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "secureclaw@example.com",
        "lud16": "secureclaw@example.com"
      }
    }
  }
}
