...
- Install via CLI: `secureclaw plugins install @secureclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `secureclaw plugins install ./extensions/zalo`
   - From npm (if published): `secureclaw plugins install @secureclaw/zalo`
...
- Approve via:
  - `secureclaw pairing list zalo`
  - `secureclaw pairing approve zalo <CODE>`
...
- Example: `secureclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `secureclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `secureclaw logs --follow`
