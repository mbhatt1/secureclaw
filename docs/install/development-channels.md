...
SecureClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SecureClaw also aligns
the install method:
...
When you switch channels with `secureclaw update`, SecureClaw also syncs plugin sources:
