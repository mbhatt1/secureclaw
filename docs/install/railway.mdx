...
Deploy SecureClaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/secureclaw` — Control UI
...
- `SECURECLAW_STATE_DIR=/data/.secureclaw` (recommended)
- `SECURECLAW_WORKSPACE_DIR=/data/workspace` (recommended)
- `SECURECLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SecureClaw state + workspace so you can migrate to another host without losing config or memory.
