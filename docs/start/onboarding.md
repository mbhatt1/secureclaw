---
summary: "First-run onboarding flow for SecureClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SecureClaw">
...
<Step title="CLI">
  ...
  The app can install the global `secureclaw` CLI via npm/pnpm so terminal
