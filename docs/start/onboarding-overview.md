---
summary: "Overview of SecureClaw onboarding options and flows"
read_when:
...
SecureClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`secureclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the SecureClaw app when you want a fully guided setup on macOS. Docs:
