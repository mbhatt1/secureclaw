...
read_when:
  - You are building a SecureClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (secureclaw.plugin.json)

Every plugin **must** ship a `secureclaw.plugin.json` file in the **plugin root**.
SecureClaw uses this manifest to validate configuration **without executing plugin
