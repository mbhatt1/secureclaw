...
This guide summarizes a sane workflow for working on the pi integration in SecureClaw.
...
- Trigger the agent directly:
  - `pnpm secureclaw agent --message "Hello" --thinking low`
...
State lives under the SecureClaw state directory. Default is `~/.secureclaw`. If `SECURECLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `secureclaw.json` for config
...
- [https://docs.secureclaw.app/testing](https://docs.secureclaw.app/testing)
- [https://docs.secureclaw.app/start/getting-started](https://docs.secureclaw.app/start/getting-started)
