---
summary: "Use Qwen OAuth (free tier) in SecureClaw"
read_when:
  - You want to use Qwen with SecureClaw
...
If you already logged in with the Qwen Code CLI, SecureClaw will sync credentials
