---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SecureClaw"
read_when:
  - You want Xiaomi MiMo models in SecureClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SecureClaw uses
