---
summary: "Use Qianfan's unified API to access many models in SecureClaw"
read_when:
...
3. SecureClaw installed on your system
...
4. Copy the API key for use with SecureClaw

## CLI setup

```bash
secureclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SecureClaw Configuration](/gateway/configuration)
