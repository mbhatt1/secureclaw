...
read_when:
  ...
  - Wiring external systems into SecureClaw
title: "Webhooks"
---
...
- `secureclaw webhooks gmail setup` writes `hooks.gmail` config for `secureclaw webhooks gmail run`.
