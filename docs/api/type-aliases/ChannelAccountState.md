...
[secureclaw](../README.md) / ChannelAccountState

# Type Alias: ChannelAccountState

> **ChannelAccountState** = `"linked"` \| `"not linked"` \| `"configured"` \| `"not configured"` \| `"enabled"` \| `"disabled"`

Defined in: [channels/plugins/types.core.ts:61](https://github.com/mbhatt1/secureclaw/blob/53b96d22f2035d8dba86478f7d5a352a687c1a00/src/channels/plugins/types.core.ts#L61)
