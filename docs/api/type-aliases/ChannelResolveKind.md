...
[secureclaw](../README.md) / ChannelResolveKind

# Type Alias: ChannelResolveKind

> **ChannelResolveKind** = `"user"` \| `"group"`

Defined in: [channels/plugins/types.adapters.ts:278](https://github.com/mbhatt1/secureclaw/blob/53b96d22f2035d8dba86478f7d5a352a687c1a00/src/channels/plugins/types.adapters.ts#L278)
