...
[secureclaw](../README.md) / ChannelAgentTool

# Type Alias: ChannelAgentTool

> **ChannelAgentTool** = `AgentTool`\<`TSchema`, `unknown`\>

Defined in: [channels/plugins/types.core.ts:15](https://github.com/mbhatt1/secureclaw/blob/53b96d22f2035d8dba86478f7d5a352a687c1a00/src/channels/plugins/types.core.ts#L15)
