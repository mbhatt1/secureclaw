...
[secureclaw](../README.md) / ChannelDirectoryEntryKind

# Type Alias: ChannelDirectoryEntryKind

> **ChannelDirectoryEntryKind** = `"user"` \| `"group"` \| `"channel"`

Defined in: [channels/plugins/types.core.ts:277](https://github.com/mbhatt1/secureclaw/blob/53b96d22f2035d8dba86478f7d5a352a687c1a00/src/channels/plugins/types.core.ts#L277)
