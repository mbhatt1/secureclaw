...
[secureclaw](../README.md) / createReplyPrefixContext

# Function: createReplyPrefixContext()

> **createReplyPrefixContext**(`params`): `ReplyPrefixContextBundle`

Defined in: [channels/reply-prefix.ts:23](https://github.com/mbhatt1/secureclaw/blob/53b96d22f2035d8dba86478f7d5a352a687c1a00/src/channels/reply-prefix.ts#L23)
