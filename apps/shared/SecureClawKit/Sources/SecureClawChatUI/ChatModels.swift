...
public typealias SecureClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SecureClawPlatformImage = UIImage
#endif

public struct SecureClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct SecureClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SecureClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SecureClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SecureClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct SecureClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SecureClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SecureClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SecureClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SecureClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SecureClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SecureClawChatMessageContent].self, forKey: .content) {
...
public struct SecureClawChatHistoryPayload: Codable, Sendable {
...
public struct SecureClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SecureClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SecureClawSessionPreviewItem]
}

public struct SecureClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SecureClawSessionPreviewEntry]

    public init(ts: Int, previews: [SecureClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SecureClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SecureClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SecureClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SecureClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SecureClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SecureClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SecureClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: SecureClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct SecureClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
