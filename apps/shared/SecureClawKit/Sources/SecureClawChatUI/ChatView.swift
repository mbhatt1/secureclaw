...
@MainActor
public struct SecureClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SecureClawChatViewModel
    ...
    public init(
        viewModel: SecureClawChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SecureClawChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SecureClawChatMessage] {
        let base: [SecureClawChatMessage]
    ...
    private func mergeToolResults(in messages: [SecureClawChatMessage]) -> [SecureClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SecureClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SecureClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SecureClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SecureClawChatMessage) -> String {
