...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.secureclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.secureclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SecureClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
