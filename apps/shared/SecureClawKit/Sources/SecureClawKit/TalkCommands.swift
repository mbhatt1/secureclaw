...
public enum SecureClawTalkCommand: String, Codable, Sendable {
...
public struct SecureClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SecureClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
