...
public enum SecureClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct SecureClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SecureClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
