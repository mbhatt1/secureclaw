...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SecureClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SecureClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
