## SecureClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_secureclaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm secureclaw gateway --port 18789 --verbose
```
