...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SecureClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SecureClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SecureClawConfigFile.loadDict()
            ...
            SecureClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/secureclaw"
        state.remoteCliPath = ""
        return state
    }
}
