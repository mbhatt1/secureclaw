...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SecureClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SecureClawProtocol.AnyCodable("start"),
                "name": SecureClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
