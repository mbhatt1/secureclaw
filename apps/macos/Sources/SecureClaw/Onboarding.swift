...
enum UIStrings {
    static let welcomeTitle = "Welcome to SecureClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "secureclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SecureClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SecureClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g secureclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SecureClawChatViewModel(
