...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.secureclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".secureclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.secureclawCommand(
            subcommand: "gateway",
