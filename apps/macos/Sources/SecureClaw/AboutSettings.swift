...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/mbhatt1/secureclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/mbhatt1/secureclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://secureclaw.app")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "SecureClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "SecureClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SecureClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SecureClawGitCommit") as? String) ??
            "unknown"
    }
