...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.secureclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SecureClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SecureClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
