...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.secureclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SecureClaw windows, but below the system’s pop-up menus.
