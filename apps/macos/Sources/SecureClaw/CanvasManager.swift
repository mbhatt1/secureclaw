...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.secureclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SecureClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__secureclaw__/a2ui/").absoluteString + "?platform=macos"
    }
