...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .secureclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SecureClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SecureClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let secureclawSelectSettingsTab = Notification.Name("secureclawSelectSettingsTab")
}
