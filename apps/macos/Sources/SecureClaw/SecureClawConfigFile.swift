...
enum SecureClawConfigFile {
    private static let logger = Logger(subsystem: "ai.secureclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        SecureClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SecureClawPaths.workspaceURL
    }
