...
final class ScreenController {
    ...
    /// Callback invoked when an secureclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SecureClawKitResources.bundle
...
/// Handles navigation policy to intercept secureclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept secureclaw:// deep links.
        if url.scheme?.lowercased() == "secureclaw" {
