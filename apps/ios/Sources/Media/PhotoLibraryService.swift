...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SecureClawPhotosLatestParams) async throws -> SecureClawPhotosLatestPayload {
        ...
        var results: [SecureClawPhotoPayload] = []
        ...
        return SecureClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SecureClawPhotoPayload
    {
