...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = SecureClawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.secureclaw.ios", category: "GatewaySettings")
            ...
            Form {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Text("Keeps the screen awake while SecureClaw is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
    ...
    private var locationMode: SecureClawLocationMode {
        SecureClawLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
