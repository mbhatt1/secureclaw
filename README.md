# 🦞 SecureClaw — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/secureclaw/secureclaw/main/docs/assets/secureclaw-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/secureclaw/secureclaw/main/docs/assets/secureclaw-logo-text.png" alt="SecureClaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/mbhatt1/secureclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/secureclaw/secureclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/mbhatt1/secureclaw/releases"><img src="https://img.shields.io/github/v/release/secureclaw/secureclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
...
[Website](https://secureclaw.app) · [Docs](https://docs.secureclaw.app) · [DeepWiki](https://deepwiki.com/secureclaw/secureclaw) · [Getting Started](https://docs.secureclaw.app/start/getting-started) · [Updating](https://docs.secureclaw.app/install/updating) · [Showcase](https://docs.secureclaw.app/start/showcase) · [FAQ](https://docs.secureclaw.app/start/faq) · [Wizard](https://docs.secureclaw.app/start/wizard) · [Nix](https://github.com/secureclaw/nix-secureclaw) · [Docker](https://docs.secureclaw.app/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`secureclaw onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.secureclaw.app/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.secureclaw.app/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.secureclaw.app/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.secureclaw.app/concepts/model-failover)
...
# or: pnpm add -g secureclaw@latest
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.secureclaw.app/start/getting-started)

```bash
secureclaw onboard --install-daemon

secureclaw gateway --port 18789 --verbose

# Send a message
secureclaw message send --to +1234567890 --message "Hello from SecureClaw"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
secureclaw agent --message "Ship checklist" --thinking high
```
...
Switch channels (git + npm): `secureclaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.secureclaw.app/install/development-channels).
...
pnpm secureclaw onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm secureclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `secureclaw` binary.

## Security defaults (DM access)

SecureClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.secureclaw.app/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `secureclaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `secureclaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.secureclaw.app/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.secureclaw.app/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.secureclaw.app/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.secureclaw.app/nodes/voicewake) + [Talk Mode](https://docs.secureclaw.app/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.secureclaw.app/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.secureclaw.app/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.secureclaw.app/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.secureclaw.app/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.secureclaw.app/nodes).
- **[Onboarding](https://docs.secureclaw.app/start/wizard) + [skills](https://docs.secureclaw.app/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=secureclaw/secureclaw&type=date&legend=top-left)](https://www.star-history.com/#secureclaw/secureclaw&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.secureclaw.app/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.secureclaw.app/web), and [Canvas host](https://docs.secureclaw.app/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.secureclaw.app/tools/agent-send): gateway, agent, send, [wizard](https://docs.secureclaw.app/start/wizard), and [doctor](https://docs.secureclaw.app/gateway/doctor).
- [Pi agent runtime](https://docs.secureclaw.app/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.secureclaw.app/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.secureclaw.app/concepts/groups).
- [Media pipeline](https://docs.secureclaw.app/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.secureclaw.app/nodes/audio).

### Channels

- [Channels](https://docs.secureclaw.app/channels): [WhatsApp](https://docs.secureclaw.app/channels/whatsapp) (Baileys), [Telegram](https://docs.secureclaw.app/channels/telegram) (grammY), [Slack](https://docs.secureclaw.app/channels/slack) (Bolt), [Discord](https://docs.secureclaw.app/channels/discord) (discord.js), [Google Chat](https://docs.secureclaw.app/channels/googlechat) (Chat API), [Signal](https://docs.secureclaw.app/channels/signal) (signal-cli), [BlueBubbles](https://docs.secureclaw.app/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.secureclaw.app/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.secureclaw.app/channels/msteams) (extension), [Matrix](https://docs.secureclaw.app/channels/matrix) (extension), [Zalo](https://docs.secureclaw.app/channels/zalo) (extension), [Zalo Personal](https://docs.secureclaw.app/channels/zalouser) (extension), [WebChat](https://docs.secureclaw.app/web/webchat).
- [Group routing](https://docs.secureclaw.app/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.secureclaw.app/channels).

### Apps + nodes

- [macOS app](https://docs.secureclaw.app/platforms/macos): menu bar control plane, [Voice Wake](https://docs.secureclaw.app/nodes/voicewake)/PTT, [Talk Mode](https://docs.secureclaw.app/nodes/talk) overlay, [WebChat](https://docs.secureclaw.app/web/webchat), debug tools, [remote gateway](https://docs.secureclaw.app/gateway/remote) control.
- [iOS node](https://docs.secureclaw.app/platforms/ios): [Canvas](https://docs.secureclaw.app/platforms/mac/canvas), [Voice Wake](https://docs.secureclaw.app/nodes/voicewake), [Talk Mode](https://docs.secureclaw.app/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.secureclaw.app/platforms/android): [Canvas](https://docs.secureclaw.app/platforms/mac/canvas), [Talk Mode](https://docs.secureclaw.app/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.secureclaw.app/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.secureclaw.app/tools/browser): dedicated secureclaw Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.secureclaw.app/platforms/mac/canvas): [A2UI](https://docs.secureclaw.app/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.secureclaw.app/nodes): camera snap/clip, screen record, [location.get](https://docs.secureclaw.app/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.secureclaw.app/automation/cron-jobs); [webhooks](https://docs.secureclaw.app/automation/webhook); [Gmail Pub/Sub](https://docs.secureclaw.app/automation/gmail-pubsub).
- [Skills platform](https://docs.secureclaw.app/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.secureclaw.app/concepts/channel-routing), [retry policy](https://docs.secureclaw.app/concepts/retry), and [streaming/chunking](https://docs.secureclaw.app/concepts/streaming).
- [Presence](https://docs.secureclaw.app/concepts/presence), [typing indicators](https://docs.secureclaw.app/concepts/typing-indicators), and [usage tracking](https://docs.secureclaw.app/concepts/usage-tracking).
- [Models](https://docs.secureclaw.app/concepts/models), [model failover](https://docs.secureclaw.app/concepts/model-failover), and [session pruning](https://docs.secureclaw.app/concepts/session-pruning).
- [Security](https://docs.secureclaw.app/gateway/security) and [troubleshooting](https://docs.secureclaw.app/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.secureclaw.app/web) + [WebChat](https://docs.secureclaw.app/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.secureclaw.app/gateway/tailscale) or [SSH tunnels](https://docs.secureclaw.app/gateway/remote) with token/password auth.
- [Nix mode](https://docs.secureclaw.app/install/nix) for declarative config; [Docker](https://docs.secureclaw.app/install/docker)-based installs.
- [Doctor](https://docs.secureclaw.app/gateway/doctor) migrations, [logging](https://docs.secureclaw.app/logging).
...
- **[Gateway WebSocket network](https://docs.secureclaw.app/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.secureclaw.app/gateway)).
- **[Tailscale exposure](https://docs.secureclaw.app/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.secureclaw.app/gateway/remote)).
- **[Browser control](https://docs.secureclaw.app/tools/browser)** — secureclaw‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.secureclaw.app/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.secureclaw.app/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.secureclaw.app/nodes/voicewake) + [Talk Mode](https://docs.secureclaw.app/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.secureclaw.app/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
Details: [Tailscale guide](https://docs.secureclaw.app/gateway/tailscale) · [Web surfaces](https://docs.secureclaw.app/web)
...
Details: [Remote access](https://docs.secureclaw.app/gateway/remote) · [Nodes](https://docs.secureclaw.app/nodes) · [Security](https://docs.secureclaw.app/gateway/security)
...
Details: [Nodes](https://docs.secureclaw.app/nodes) · [macOS app](https://docs.secureclaw.app/platforms/macos) · [Gateway protocol](https://docs.secureclaw.app/concepts/architecture)
...
Details: [Session tools](https://docs.secureclaw.app/concepts/session-tool)
...
- Controlled via `secureclaw nodes …`.

Runbook: [iOS connect](https://docs.secureclaw.app/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.secureclaw.app/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.secureclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.secureclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.secureclaw/secureclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.secureclaw.app/gateway/configuration)
...
Details: [Security guide](https://docs.secureclaw.app/gateway/security) · [Docker + sandboxing](https://docs.secureclaw.app/install/docker) · [Sandbox config](https://docs.secureclaw.app/gateway/configuration)

### [WhatsApp](https://docs.secureclaw.app/channels/whatsapp)

- Link the device: `pnpm secureclaw channels login` (stores creds in `~/.secureclaw/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.secureclaw.app/channels/telegram)
...
### [Slack](https://docs.secureclaw.app/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.secureclaw.app/channels/discord)
...
### [Signal](https://docs.secureclaw.app/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.secureclaw.app/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.secureclaw.app/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.secureclaw.app/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.secureclaw.app/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.secureclaw.app)
- [Read the architecture overview for the gateway + protocol model.](https://docs.secureclaw.app/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.secureclaw.app/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.secureclaw.app/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.secureclaw.app/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.secureclaw.app/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.secureclaw.app/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.secureclaw.app/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.secureclaw.app/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.secureclaw.app/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.secureclaw.app/platforms/windows), [Linux](https://docs.secureclaw.app/platforms/linux), [macOS](https://docs.secureclaw.app/platforms/macos), [iOS](https://docs.secureclaw.app/platforms/ios), [Android](https://docs.secureclaw.app/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.secureclaw.app/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.secureclaw.app/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.secureclaw.app/gateway/discovery)
- [Bonjour/mDNS](https://docs.secureclaw.app/gateway/bonjour)
- [Gateway pairing](https://docs.secureclaw.app/gateway/pairing)
- [Remote gateway README](https://docs.secureclaw.app/gateway/remote-gateway-readme)
- [Control UI](https://docs.secureclaw.app/web/control-ui)
- [Dashboard](https://docs.secureclaw.app/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.secureclaw.app/gateway/health)
- [Gateway lock](https://docs.secureclaw.app/gateway/gateway-lock)
...
- [Agent loop](https://docs.secureclaw.app/concepts/agent-loop)
- [Presence](https://docs.secureclaw.app/concepts/presence)
- [TypeBox schemas](https://docs.secureclaw.app/concepts/typebox)
- [RPC adapters](https://docs.secureclaw.app/reference/rpc)
- [Queue](https://docs.secureclaw.app/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.secureclaw.app/tools/skills-config)
- [Default AGENTS](https://docs.secureclaw.app/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.secureclaw.app/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.secureclaw.app/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.secureclaw.app/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.secureclaw.app/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.secureclaw.app/reference/templates/TOOLS)
- [Templates: USER](https://docs.secureclaw.app/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.secureclaw.app/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.secureclaw.app/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.secureclaw.app/platforms/mac/voicewake)
- [iOS node](https://docs.secureclaw.app/platforms/ios)
- [Android node](https://docs.secureclaw.app/platforms/android)
- [Windows (WSL2)](https://docs.secureclaw.app/platforms/windows)
- [Linux app](https://docs.secureclaw.app/platforms/linux)

## Email hooks (Gmail)

- [docs.secureclaw.app/gmail-pubsub](https://docs.secureclaw.app/automation/gmail-pubsub)

## Molty

SecureClaw was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [secureclaw.app](https://secureclaw.app)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@secureclaw](https://x.com/secureclaw)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-secureclawbot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-secureclawbot" title="seans-secureclawbot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
