...
const SANDBOX_EXAMPLES = {
  main: [
    ["secureclaw sandbox list", "List all sandbox containers."],
    ...
    ["secureclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["secureclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["secureclaw sandbox list", "List all sandbox containers."],
    ["secureclaw sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["secureclaw sandbox explain", "Show effective sandbox config."],
    ["secureclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["secureclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["secureclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.secureclaw.app/cli/sandbox")}\n`,
    )
    .action(() => {
