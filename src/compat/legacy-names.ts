export const PROJECT_NAME = "secureclaw" as const;

export const LEGACY_PROJECT_NAMES = ["openclaw", "clawdbot", "moltbot"] as const;
...
export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/SecureClaw" as const;
