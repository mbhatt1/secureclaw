...
export type ChannelAgentToolFactory = (params: { cfg?: SecureClawConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: SecureClawConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SecureClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SecureClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SecureClawConfig }) => boolean;
  supportsCards?: (params: { cfg: SecureClawConfig }) => boolean;
