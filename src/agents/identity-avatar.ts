...
function resolveAvatarSource(cfg: SecureClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SecureClawConfig, agentId: string): AgentAvatarResolution {
