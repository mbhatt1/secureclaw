  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "secureclaw-sbx-test",
        "--label",
        "secureclaw.sandbox=1",
        "--label",
        "secureclaw.sessionKey=main",
        "--label",
        "secureclaw.createdAtMs=1700000000000",
        "--label",
        "secureclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
