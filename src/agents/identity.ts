import type { SecureClawConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: SecureClawConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: SecureClawConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[secureclaw]";
}
