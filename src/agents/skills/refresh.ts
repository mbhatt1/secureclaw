...
function resolveWatchPaths(workspaceDir: string, config?: SecureClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SecureClawConfig }) {
