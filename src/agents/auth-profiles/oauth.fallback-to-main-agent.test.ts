...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSecureClawAgentDir() returns mainAgentDir
    process.env.SECURECLAW_STATE_DIR = tmpDir;
    process.env.SECURECLAW_AGENT_DIR = mainAgentDir;
