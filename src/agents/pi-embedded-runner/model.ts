...
// pi-ai's built-in Anthropic catalog can lag behind SecureClaw's defaults/docs.
...
export function buildModelAliasLines(cfg?: SecureClawConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveSecureClawAgentDir();
