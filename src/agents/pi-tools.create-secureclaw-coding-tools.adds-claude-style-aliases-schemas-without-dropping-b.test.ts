...
describe("createSecureClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createSecureClawCodingTools({
      config,
    ...
    const anthropicTools = createSecureClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSecureClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSecureClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
