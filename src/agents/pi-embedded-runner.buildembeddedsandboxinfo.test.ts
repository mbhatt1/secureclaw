...
const _ensureModels = (cfg: SecureClawConfig, agentDir: string) =>
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/secureclaw-sandbox",
      agentWorkspaceDir: "/tmp/secureclaw-workspace",
      ...
      browser: {
        ...
        containerName: "secureclaw-sbx-browser-test",
      },
