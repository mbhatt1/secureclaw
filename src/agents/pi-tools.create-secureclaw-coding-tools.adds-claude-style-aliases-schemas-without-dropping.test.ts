...
import { __testing, createSecureClawCodingTools } from "./pi-tools.js";
import { createSandboxedReadTool } from "./pi-tools.read.js";
import { createSecureClawTools } from "./secureclaw-tools.js";
import { createBrowserTool } from "./tools/browser-tool.js";

const defaultTools = createSecureClawCodingTools();

describe("createSecureClawCodingTools", () => {
  ...
  it("keeps raw core tool schemas union-free", () => {
    const tools = createSecureClawTools();
  ...
  it("does not expose provider-specific message tools", () => {
    const tools = createSecureClawCodingTools({ messageProvider: "discord" });
  ...
  it("applies sandbox path guards to file_path alias", async () => {
    const tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "secureclaw-sbx-"));
    const outsidePath = path.join(os.tmpdir(), "secureclaw-outside.txt");
