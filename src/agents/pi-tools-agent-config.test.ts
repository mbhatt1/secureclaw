...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createSecureClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createSecureClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createSecureClawCodingTools({
      config: cfg,
    ...
    const defaultTools = createSecureClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createSecureClawCodingTools({
      config: cfg,
    ...
    const bobTools = createSecureClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createSecureClawCodingTools({
      config: cfg,
