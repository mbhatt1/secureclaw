...
export const normalizePluginsConfig = (
  config?: SecureClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SecureClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SecureClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SecureClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
