...
import {
  ...
  type SecureClawPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @secureclaw/voice-call -> voice-call).
...
export function discoverSecureClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".secureclaw", "extensions")];
