...
import type { SecureClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: SecureClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: SecureClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: SecureClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: SecureClawConfig) => void;
  log: {
