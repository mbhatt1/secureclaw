...
import { type SecureClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SecureClawConfig): string[] {
...
export function listAgentsForGateway(cfg: SecureClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SecureClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: SecureClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: SecureClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: SecureClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SecureClawConfig): GatewaySessionsDefaults {
