...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@secureclaw", { botUsername: "secureclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@secureclaw args", {
        botUsername: "secureclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@secureclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "secureclaw" })).toBe(
      "/help@otherbot",
    );
  });
