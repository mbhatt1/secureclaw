...
function resolveMentionPatterns(cfg: SecureClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SecureClawConfig | undefined, agentId?: string): RegExp[] {
