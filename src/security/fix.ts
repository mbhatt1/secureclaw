...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SecureClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SecureClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SecureClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
