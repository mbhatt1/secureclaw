...
import type { SecureClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SecureClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SecureClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
