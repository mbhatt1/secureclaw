...
export const A2UI_PATH = "/__secureclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__secureclaw__/canvas";

export const CANVAS_WS_PATH = "/__secureclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.secureclawCanvasA2UIAction.postMessage(...)
  // - Android: window.secureclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["secureclawCanvasA2UIAction"];
  ...
  globalThis.SecureClaw = globalThis.SecureClaw ?? {};
  globalThis.SecureClaw.postMessage = postToNode;
  globalThis.SecureClaw.sendUserAction = sendUserAction;
  globalThis.secureclawPostMessage = postToNode;
  globalThis.secureclawSendUserAction = sendUserAction;
