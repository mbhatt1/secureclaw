...
export async function setupSkills(
  ...
  if (installable.length > 0) {
    ...
    for (const name of selected) {
      ...
      runtime.log(
        `Tip: run \`${formatCliCommand("secureclaw doctor")}\` to review skills + requirements.`,
      );
      runtime.log("Docs: https://docs.secureclaw.app/skills");
    }
  }
