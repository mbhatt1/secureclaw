...
function resolveDefaultAccountId(cfg: SecureClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SecureClawConfig): boolean {
...
export function summarizeBindings(cfg: SecureClawConfig, bindings: AgentBinding[]): string[] {
