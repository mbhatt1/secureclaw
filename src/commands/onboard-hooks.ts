...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.secureclaw.app/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("secureclaw hooks list")}`,
      `  ${formatCliCommand("secureclaw hooks enable <name>")}`,
      `  ${formatCliCommand("secureclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
