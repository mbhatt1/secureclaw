...
const ensureSecureClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveSecureClawAgentDir = vi.fn().mockReturnValue("/tmp/secureclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/secureclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSecureClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveSecureClawAgentDir,
}));
