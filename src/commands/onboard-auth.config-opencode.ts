...
export function applyOpencodeZenProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyOpencodeZenConfig(cfg: SecureClawConfig): SecureClawConfig {
