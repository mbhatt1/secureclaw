...
export function summarizeExistingConfig(config: SecureClawConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.secureclaw.app/gateway/remote",
    "https://docs.secureclaw.app/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
