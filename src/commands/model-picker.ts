...
function resolveConfiguredModelRaw(cfg: SecureClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: SecureClawConfig): string[] {
...
export function applyPrimaryModel(cfg: SecureClawConfig, model: string): SecureClawConfig {
...
export function applyModelAllowlist(cfg: SecureClawConfig, models: string[]): SecureClawConfig {
  const defaults = cfg.agents?.defaults;
