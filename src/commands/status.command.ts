...
export async function statusCommand(
  ...
  runtime.log(theme.heading("SecureClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("secureclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("secureclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.secureclaw.app/faq");
  runtime.log("Troubleshooting: https://docs.secureclaw.app/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("secureclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("secureclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("secureclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("secureclaw gateway probe")}`);
  }
}
