...
export function applyOpenAIProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyOpenAIConfig(cfg: SecureClawConfig): SecureClawConfig {
