...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "secureclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SecureClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SecureClawConfig["telegram"]>>,
