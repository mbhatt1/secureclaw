...
export function applyOpenrouterProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyOpenrouterConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyLitellmProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyMoonshotProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyMoonshotConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyMoonshotConfigCn(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyKimiCodeProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applySyntheticProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyXiaomiProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SecureClawConfig): SecureClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SecureClawConfig): SecureClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyXaiProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyQianfanProviderConfig(cfg: SecureClawConfig): SecureClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: SecureClawConfig): SecureClawConfig {
