...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "secureclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSecureClawPackageRoot } = await import("./secureclaw-root.js");
    ...
    vi.mocked(resolveSecureClawPackageRoot).mockResolvedValue("/opt/secureclaw");
