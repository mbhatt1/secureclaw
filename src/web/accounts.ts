...
function listConfiguredAccountIds(cfg: SecureClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: SecureClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SecureClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SecureClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SecureClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SecureClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SecureClawConfig): ResolvedWhatsAppAccount[] {
