...
function resolveAnthropicDefaultAuthMode(cfg: SecureClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyTalkApiKey(config: SecureClawConfig): SecureClawConfig {
...
export function applyModelDefaults(cfg: SecureClawConfig): SecureClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyLoggingDefaults(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyContextPruningDefaults(cfg: SecureClawConfig): SecureClawConfig {
...
export function applyCompactionDefaults(cfg: SecureClawConfig): SecureClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
