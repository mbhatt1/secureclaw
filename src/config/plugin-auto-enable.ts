...
function isTelegramConfigured(cfg: SecureClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: SecureClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: SecureClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: SecureClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: SecureClawConfig): boolean {
...
function isIMessageConfigured(cfg: SecureClawConfig): boolean {
...
function isWhatsAppConfigured(cfg: SecureClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: SecureClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: SecureClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: SecureClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: SecureClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: SecureClawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: SecureClawConfig, pluginId: string): SecureClawConfig {
...
function registerPluginEntry(cfg: SecureClawConfig, pluginId: string): SecureClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
