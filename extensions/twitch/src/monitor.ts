...
import type { ReplyPayload, SecureClawConfig } from "secureclaw/plugin-sdk";
import { createReplyPrefixOptions } from "secureclaw/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // SecureClawConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SecureClawConfig;
