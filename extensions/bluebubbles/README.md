...
This directory contains the **BlueBubbles external channel plugin** for SecureClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `secureclaw/plugin-sdk` helpers.
