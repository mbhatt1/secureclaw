...
export function listMattermostAccountIds(cfg: SecureClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SecureClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SecureClawConfig): ResolvedMattermostAccount[] {
