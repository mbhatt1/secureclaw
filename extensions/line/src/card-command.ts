import type { LineChannelData, SecureClawPluginApi, ReplyPayload } from "secureclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SecureClawPluginApi): void {
  api.registerCommand({
    name: "card",
