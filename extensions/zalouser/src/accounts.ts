...
export function listZalouserAccountIds(cfg: SecureClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SecureClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: SecureClawConfig, accountId: string): ZalouserAccountConfig {
