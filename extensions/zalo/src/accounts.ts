...
export function listZaloAccountIds(cfg: SecureClawConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: SecureClawConfig): string {
...
function mergeZaloAccountConfig(cfg: SecureClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SecureClawConfig): ResolvedZaloAccount[] {
