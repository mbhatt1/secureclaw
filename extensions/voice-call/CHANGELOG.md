...
- Version alignment with core SecureClaw release numbers.
...
- First public release of the @secureclaw/voice-call plugin.
...
- CLI: `secureclaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
