...
export function listGoogleChatAccountIds(cfg: SecureClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SecureClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SecureClawConfig): ResolvedGoogleChatAccount[] {
