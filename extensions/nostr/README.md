...
Nostr DM channel plugin for SecureClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SecureClaw. It enables your bot to:
...
# Configure secureclaw to use local relay
