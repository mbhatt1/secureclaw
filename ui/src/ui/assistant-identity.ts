...
declare global {
  interface Window {
    __SECURECLAW_ASSISTANT_NAME__?: string;
    __SECURECLAW_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__SECURECLAW_ASSISTANT_NAME__,
    avatar: window.__SECURECLAW_ASSISTANT_AVATAR__,
  });
}
