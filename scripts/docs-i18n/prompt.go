...
- Keep product names in English: SecureClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SecureClaw Gateway, use "Gateway 网关".
