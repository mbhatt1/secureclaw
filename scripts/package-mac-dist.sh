...
# Output:
# - dist/SecureClaw.app
# - dist/SecureClaw-<version>.zip
# - dist/SecureClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/SecureClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SecureClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/SecureClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SecureClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SecureClaw-$VERSION.dSYM.zip"
