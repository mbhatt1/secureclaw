...
if [[ -z "$version_content" ]]; then
  echo "<h2>SecureClaw $VERSION</h2>"
  echo "<p>Latest SecureClaw update.</p>"
  echo "<p><a href=\"https://github.com/mbhatt1/secureclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
