...
- `fix: <summary> (secureclaw#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (secureclaw#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "secureclaw#$pr_number" || { echo "ERROR: commit subject missing secureclaw#$pr_number"; exit 1; }
